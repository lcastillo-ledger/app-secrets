...
PATH_APP_LOAD_PARAMS = "44'/58049'"   # purpose=coin(44) / Ledger Encrypt private coin type
...
########################################
#       Swap/TLV/PKI disabled          #
########################################
# This minimal app only supports GET_VERSION and GET_APP_NAME.
